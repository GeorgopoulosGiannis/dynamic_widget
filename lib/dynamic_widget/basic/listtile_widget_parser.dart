...
class ListTileWidgetParser extends WidgetParser {
  ...
  Widget parse(Map<String, dynamic> map, BuildContext buildContext, ClickListener? listener) {
    ...
    EdgeInsetsGeometry? contentPadding =
        map.containsKey("contentPadding") ? parseEdgeInsetsGeometry(map["contentPadding"]) : null;
    ...
    Widget? subtitle = map.containsKey("subtitle")
        ? sl<DynamicWidgetBuilder>().buildFromMap(map["subtitle"], buildContext, listener)
        : null;
    Widget? title =
        map.containsKey("title") ? sl<DynamicWidgetBuilder>().buildFromMap(map["title"], buildContext, listener) : null;
    Widget? trailing = map.containsKey("trailing")
        ? sl<DynamicWidgetBuilder>().buildFromMap(map["trailing"], buildContext, listener)
        : null;
